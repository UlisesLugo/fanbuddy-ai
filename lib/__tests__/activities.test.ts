...
describe('buildDayEntries', () => {
  ...
  it('returns 4 entries for a 4-day trip', () => {
    const eoyKickoffUtc = '2026-12-31T18:00:00Z';
    const result = buildDayEntries(eoyKickoffUtc, {
      checkIn: '2026-12-30',
      checkOut: '2027-01-02',
    });
...
describe('buildActivitiesPrompt', () => {
  ...
  it('includes city, home team, and away team', () => {
    const prompt = buildActivitiesPrompt(match, {
      checkIn: '2026-04-19',
      checkOut: '2026-04-21',
    });
  ...
  it('falls back to venue when match_city is undefined', () => {
    ...
    const prompt = buildActivitiesPrompt(matchNoCity, {
      checkIn: '2026-04-19',
      checkOut: '2026-04-21',
    });
